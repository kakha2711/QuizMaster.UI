...
namespace QuizMaster.Core.Model
{
    public class Lecturer :Person
    {
        ...
        {
            return $"Id: {Id}, FirsName: {FirsName}, Lastname: {Lastname}, Email: {Email}, PhoneNumber: {PhoneNumber}, PhoneNumber: {PhoneNumber}, Password: {Password}, VerificationCode: {VerificationCode}, IsVerified: {IsVerified}, Role: {Role}, Gender: {Gender}, subject: {Subject}";
        }
    }
